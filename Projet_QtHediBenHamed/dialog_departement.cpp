...
void Dialog_departement::on_pushButton_ajouter_clicked()
{
     ...
     int CodeDepartement = ui->lineEdit_Code->text().toInt();
     int Id_CATEGORIE =ui->lineEdit_ide ->text().toInt();
     QString Libelle_Departement = ui->lineEdit_Libelle->text();
...
{
    int CodeDepartement2 = ui->lineEdit_Code_modifier2->text().toInt();
    //int CodeDepartement = ui->lineEdit_Code_modifier->text().toInt();
    int Id_CATEGORIE =ui->lineEdit_ide_modifier ->text().toInt();
    QString Libelle_Departement = ui->lineEdit_Libelle_modifier->text();
